...
- Service: `services/ai_service.go`, `services/ai_chat_service.go`, `services/ai_memory_service.go`。
- MySQL 仓储: `repositories/mysql/ai_conversation_repository.go`, `repositories/mysql/ai_properties_repository.go`。
- Mongo 消息仓储: `repositories/mongo/ai_message_repository.go`。
